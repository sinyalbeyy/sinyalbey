                ...
                <div className="flex items-center gap-1.5">
                  ...
                  {(() => {
                    ...
                    const welcomeMsg = encodeURIComponent(
                      'VIP ailemize hoş geldin canım! 🥂\n\nDışarıdaki kalabalıktan kurtuldun, artık gerçek kazançların olduğu yerdesin. Sinyaller yolda, bildirimleri aç! 🎯\n\n📍 Kanal Linkimiz: 👇 https://t.me/+yMo9RbqCLsliYWQ0'
                    );
                    return (
                      <a
                        href={isValid ? `https://t.me/${tgHandle}?text=${welcomeMsg}` : undefined}
                        target="_blank"
                        rel="noopener noreferrer"
                        onClick={(e) => !isValid && e.preventDefault()}
                        aria-disabled={!isValid}
                        title={isValid ? `Hoş geldin mesajı gönder: ${username}` : 'Geçersiz kullanıcı adı'}
                      ...
                      >
                        ...
                        <span className="hidden sm:inline">Hoş Geldin Gönder</span>
                      </a>
                    );
                  })()}
                </div>
